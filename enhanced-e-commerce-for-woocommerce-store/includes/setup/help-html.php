...
function info_htnml($validation){
  if($validation == true){
    return '<img src="'.esc_url_raw(ENHANCAD_PLUGIN_URL."/admin/images/config-success.svg").'" alt="configuration  success" class="config-success">';
  }else{
    return '<img src="'.esc_url_raw(ENHANCAD_PLUGIN_URL."/admin/images/exclaimation.png").'" alt="configuration  success" class="config-fail">';
  }
}
    ...
    <nav>
        <ul class="pagination justify-content-center">
          <li class="page-item page-prev h-page-prev">
            <span class="page-link"><img src="<?php echo esc_url_raw(ENHANCAD_PLUGIN_URL.'/admin/images/icon/arrow-down-sign-to-navigate.svg'); ?>" alt=""/></span>
          </li>
